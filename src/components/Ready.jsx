...
import { IonPage, IonToggle, IonHeader, IonToolbar, IonTitle, IonContent, IonCard, IonLabel, IonItem } from '@ionic/react';
      ...
      <IonContent fullscreen>
        ...
        <IonCard>
          ...
          <IonItem>
            ...
            <IonToggle value={four} onIonChange={e => setFour(e.detail.checked)}/>
          </IonItem>
          <IonItem>
            <IonLabel>
                <h2>strictモードにする</h2>
